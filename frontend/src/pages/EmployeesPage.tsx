...
export default function EmployeesPage({ currentUser }: EmployeesPageProps) {
    ...
    return (
        <div style={{
            ...
            {/* Create Form */}
            <form onSubmit={handleCreate} autoComplete="off" style={{ marginBottom: "2rem", display: 'flex', gap: '1rem', alignItems: 'flex-end' }}>
                <div style={{ flex: 1 }}>
                ...
                <div style={{ flex: 1 }}>
                    ...
                    <div style={{ position: 'relative' }}>
                        <input
                            ...
                            style={{ padding: "0.75rem", width: "100%", borderRadius: '8px', border: '1px solid #bee3f8', fontSize: '0.95rem', outline: 'none', color: '#2d3748', backgroundColor: '#ebf8ff', paddingRight: '3rem' }}
